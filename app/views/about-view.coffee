...
// a sort-of sandboxed environment. Thanks to redis being so awesome, \n
//  \n
// typical round-trip time is about 60ms. This service is in alpha, so you can \n
// most definately crash it if you set your mind to it. If you have any feedback \n
// on this service or just want to say hi, tweet me @svammel. \n
//  \n
// Cheers Emil \n
//  \n
"
